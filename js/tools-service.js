...
const ToolsService = (function() {
    ...
    const proxies = [
      { name: 'CodeTabs',          formatUrl: url => `https://api.codetabs.com/v1/proxy?quest=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins (win)',  formatUrl: url => `https://api.allorigins.win/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins (cf)',   formatUrl: url => `https://api.allorigins.cf/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins (pro)',  formatUrl: url => `https://api.allorigins.pro/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins (app)',  formatUrl: url => `https://allorigins.appspot.com/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'CORS Anywhere',     formatUrl: url => `https://cors-anywhere.herokuapp.com/${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'ThingProxy FB',     formatUrl: url => `https://thingproxy.freeboard.io/fetch/${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'ThingProxy PW',     formatUrl: url => `https://thingproxy.pw/fetch/${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'CORSProxy.io',      formatUrl: url => `https://corsproxy.io/?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'CORS.bridged.cc',   formatUrl: url => `https://cors.bridged.cc/?uri=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'YACDN',             formatUrl: url => `https://yacdn.org/proxy/${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'JSONP afeld',       formatUrl: url => `https://jsonp.afeld.me/?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { const json = await res.json(); return json.contents; } catch (e) { return `Error parsing JSONP response: ${e.message}`; } } },
      { name: 'CORS Proxy HTML',   formatUrl: url => `https://cors-proxy.htmldriven.com/?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins .net',   formatUrl: url => `https://api.allorigins.net/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins .io',    formatUrl: url => `https://api.allorigins.io/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'AllOrigins .eu',    formatUrl: url => `https://api.allorigins.eu/raw?url=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
      { name: 'ProxyCORS',         formatUrl: url => `https://api.codetabs.com/v1/proxy?quest=${encodeURIComponent(url)}`, parseResponse: async res => { try { return await res.text(); } catch (e) { return `Error parsing response: ${e.message}`; } } },
